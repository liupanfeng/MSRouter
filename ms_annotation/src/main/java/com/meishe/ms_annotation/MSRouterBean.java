...
public class MSRouterBean {
    ...
    private MSRouterBean(TypeEnum typeEnum, /*Element element,*/ Class<?> myClass, String path, String group) {
        this.typeEnum = typeEnum;
        // this.element = element;
        this.myClass = myClass;
        this.path = path;
    ...
    public static MSRouterBean create(TypeEnum type, Class<?> clazz, String path, String group) {
        return new MSRouterBean(type, clazz, path, group);
    }

    // 构建者模式相关
    private MSRouterBean(Builder builder) {
